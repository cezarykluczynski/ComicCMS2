    ...
    'bjyauthorize' => [
        ...
        'guards' => [
            'BjyAuthorize\Guard\Controller' => [
                ...
                ['controller' => 'ComicCmsTestHelper\Controller\SetupConsole', 'action' => 'create-entity', 'roles' => ['guest']],
                ['controller' => 'ComicCmsTestHelper\Controller\SetupConsole', 'action' => 'load-fixtures', 'roles' => ['guest']],
                ['controller' => 'ComicCmsTestHelper\Controller\TeardownConsole', 'action' => 'remove-entity', 'roles' => ['guest']],
                ['controller' => 'ComicCmsTestHelper\Controller\TeardownConsole', 'action' => 'unload-fixtures', 'roles' => ['guest']],
            ],
        ],
    ],
];